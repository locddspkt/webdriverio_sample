const GLOBALS_CONSTANTS = {
    IS_LOCAL: true,
    IS_DEV: false,
    IS_PRODUCTION: false,
    DOWNLOAD_FOLDER: '',//this folder is set runtime for each spec
    BASE_DOWNLOAD_FOLDER: '', //this is the base, the new folder will be created runtime
...
exports.config = {
    ...
    capabilities: [
        ...
        //     // },
        {
            ...
            chromeOptions: {
                prefs: {
                    'download.default_directory': GLOBALS_CONSTANTS.DOWNLOAD_FOLDER
                }
            }
    ...
    beforeSession: function (config, capabilities, specs) {
        ...
        capabilities.chromeOptions.prefs['download.default_directory'] = GLOBALS_CONSTANTS.DOWNLOAD_FOLDER = currentSpec;
    },
    /**
    ...
    before: function (capabilities, specs) {
        ...
        SAMPLE_DOWNLOAD_PAGE = 'https://sample-videos.com/download-sample-png-image.php';

        var fs = require('fs');
        var fse = require('fs-extra');

        getFilesInFolder = async function (folder) {
            return await fse.readdir(folder);
        };
